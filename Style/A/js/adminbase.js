...
function loadUser(id,uname){
	ui.box.load("/admin/members/member?id="+id, {title:uname+" ->的详细信息"});
}
...
function loadTixian(id,uname){
	ui.box.load("/admin/withdrawlog/edit?id="+id, {title:uname+" ->的编辑信息"});
}
function loadTixianwait(id,uname){
	ui.box.load("/admin/withdrawlogwait/edit?id="+id, {title:uname+" ->的编辑信息"});
}
function loadTixianing(id,uname){
	ui.box.load("/admin/withdrawloging/edit?id="+id, {title:uname+" ->的编辑信息"});
}
