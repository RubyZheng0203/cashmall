;(function($){
    ...
    $('body').append('<style>'+
                ...
                '.sel-box .btn{background:#3399cc;overflow:hidden;}'+
                ...
                '.sel-con .border{height:34px;border:solid 1px #3399cc;border-width:1px 0;position:absolute;bottom:72px;left:0;right:0;pointer-events:none;}'+
                ...
                '.sel-con .scroll{-webkit-overflow-scrolling:auto;height:180px;overflow:auto;box-sizing:border-box;padding:72px 0;width:200%;padding-right:100%;}'+
