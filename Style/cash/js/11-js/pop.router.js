...
POP.splash = function() {
    ...
    POP.draw.text(40,130,'戳泡泡！',64,'#0085d1');
    POP.draw.text(110,240, POP.Ua.action + '开始游戏', 16, col);
    POP.draw.text(128, 300, '最高分', 20, '#0085d1');
    POP.draw.text("center", 340, POP.hiScore.toString(), 24, '#0085d1');
...
POP.gameOver = function() {
    ...
    // display scores
	POP.draw.text(115,160,'泡泡数: '+POP.score.burst, 16, '#0085d1');
    POP.draw.text(115,190,'精准度: ' + POP.score.accuracy + '%', 16, '#0085d1'); 
    POP.draw.text(131,220,'时间: ' + POP.score.seconds, 16, '#0085d1'); 
    POP.draw.text("center",270,'' + POP.score.total, 30, '#0085d1'); 
