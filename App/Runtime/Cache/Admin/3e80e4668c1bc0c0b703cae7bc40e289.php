...
<div class="so_main">
	...
	<div class="form2">
		<form method="get" action="__URL__/recheck">
			<dl class="lineD">
		      <dt>借款申请编号：</dt>
		      <dd>
	...
	<div class="list">
		<table id="area_list" width="100%" border="0" cellspacing="0" cellpadding="0">
			...
			<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr overstyle='on' id="list_<?php echo ($vo["id"]); ?>">
					...
					<td><?php echo (date("Y-m-d H:i",$vo["signed_time"])); ?></td>
			        <td>
						<a href="javascript:;" onclick="edit('?uid=<?php echo ($vo["uid"]); ?>&id=<?php echo ($vo["id"]); ?>')">[线下申请]</a>
						<a href="javascript:;" onclick="cancel(<?php echo ($vo["id"]); ?>,1)">[取消]</a>
			        </td>
	       		</tr>
